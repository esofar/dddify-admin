export default {
  ...
  'user.formTitle.create': 'Create User',
  'user.formTitle.update': 'Update User',
  'user.formTitle.assignRoles': 'Assign Roles',
  'user.formTitle.restPassword': 'Reset Password',
  'user.button.assignRoles': 'Assign Roles',
  'user.button.resetPassword': 'Reset Password',
  'user.assign.roles.source': 'Available',
  'user.assign.roles.target': 'Assigned',
  'user.rules.noSpecial':
    'Only letters, numbers, Chinese characters, and underscores are allowed',
  'user.rules.confirmPassword': 'The two passwords do not match',
