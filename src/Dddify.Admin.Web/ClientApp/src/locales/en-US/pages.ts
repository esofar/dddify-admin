export default {
  ...
  'announcement.label.index': 'No.',
  'announcement.label.title': 'Title',
  'announcement.label.summary': 'Summary',
  'announcement.label.content': 'Content',
  'announcement.label.status': 'Status',
  'announcement.label.audienceType': 'Audience',
  'announcement.label.audienceTargetIds': 'Audience Targets',
  'announcement.label.createdAt': 'Created At',
  'announcement.label.publishedAt': 'Published At',
  'announcement.label.withdrawnAt': 'Withdrawn At',
  'announcement.label.option': 'Actions',
  'announcement.status.draft': 'Draft',
  'announcement.status.published': 'Published',
  'announcement.status.withdrawn': 'Withdrawn',
  'announcement.audience.allUsers': 'All Users',
  'announcement.audience.departments': 'Departments',
  'announcement.audience.roles': 'Roles',
  'announcement.audience.specificUsers': 'Specific Users',
  'announcement.action.create': 'Create Announcement',
  'announcement.action.update': 'Update Announcement',
  'announcement.action.detail': 'Announcement Detail',
  'announcement.action.publish': 'Publish',
  'announcement.action.withdraw': 'Withdraw',
  'announcement.confirm.publish.title': 'Publish this announcement?',
  'announcement.confirm.publish.description':
    'After publishing, matched users will receive inbox messages and the announcement cannot be edited.',
  'announcement.confirm.withdraw.title': 'Withdraw this announcement?',
  'announcement.confirm.withdraw.description':
    'After withdrawal, users will no longer see this announcement as active.',
  'announcement.confirm.delete.title': 'Delete this announcement?',
  'announcement.confirm.delete.description':
    'After deletion, this announcement will be removed. Published announcements must be withdrawn before deletion.',
  'announcement.message.publish.success': 'Published successfully',
  'announcement.message.publish.failure': 'Failed to publish',
  'announcement.message.withdraw.success': 'Withdrawn successfully',
  'announcement.message.withdraw.failure': 'Failed to withdraw',
};
